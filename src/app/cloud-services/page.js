...
export const metadata = {
  title: "Cloud & Azure Solutions - Amlgo Labs",
  description: "Unlock the power of the cloud with Amlgo Labs. Explore Azure, AWS, and Google Cloud solutions including hosting, storage, security, cost optimization, and cloud-native services for businesses.",
...
const page = () => {
    const industryData = [
        ...
        { industryName: 'Real Estate', description: 'Streamline operations with smart data management and analytics.', link: '/real-estate' , icon: <MdRealEstateAgent/>},
