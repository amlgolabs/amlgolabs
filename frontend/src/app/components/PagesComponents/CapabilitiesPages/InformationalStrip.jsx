...
//                     <button className="globalButtonBlack">Read More</button>
//                     </Link>
//                 </div>
...
//                     <button className="globalButtonBlack">Explore Now</button>
//                     </Link>
//                 </div>
//             </div>
//         </div>
...
import Image from 'next/image';
import Link from 'next/link';
// import styles from "./InformationalStrip.module.css";
import styles from "../../../styles/pages/Components/CapabilitiesPages/InformationalStrip.module.css"
