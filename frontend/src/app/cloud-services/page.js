...
export const metadata = {
  ...
  keywords: "Cloud Solutions, AWS, Azure, GCP, cloud consulting, cloud migration, Amlgo Labs, scalable infrastructure, cloud security, multi-cloud strategy, cloud optimization, hybrid cloud, cloud architecture, cloud adoption, digital transformation",
};
