// components/PrivacyPolicy/PrivacyPolicy.jsx
...
export default function PrivacyPolicy() {
  return (
    <div className={styles.container}>
      ...
      <p className={styles.lastUpdated}>Last updated: April 07, 2025</p>
      ...
      <section className={styles.section}>
        ...
        <h3 className={styles.subTitle}>Interpretation</h3>
        ...
        <ul className={styles.list}>
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to AMLGO LABS PRIVATE LIMITED, AMLGO LABS INC, 2055, LIMESTONE RD, STE 200-C, DELAWARE 19808.</li>
          ...
          <li><strong>Website</strong> refers to Amlgo Labs, accessible from <a href="https://amlgolabs.com/" className={styles.link}>https://amlgolabs.com/</a></li>
      ...
      <section className={styles.section}>
        ...
        <h3 className={styles.subTitle}>Types of Data Collected</h3>
        
        <h4 className={styles.subSubTitle}>Personal Data</h4>
        <p className={styles.paragraph}>
        ...
        <h4 className={styles.subSubTitle}>Usage Data</h4>
        <p className={styles.paragraph}>
      ...
      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>Tracking Technologies and Cookies</h2>
        <p className={styles.paragraph}>
      ...
      <section className={styles.section}>
        ...
        <h3 className={styles.subTitle}>Business Transactions</h3>
        <p className={styles.paragraph}>
          If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
        </p>

        <h3 className={styles.subTitle}>Law enforcement</h3>
        <p className={styles.paragraph}>
          Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
        </p>

        <h3 className={styles.subTitle}>Other legal requirements</h3>
        <p className={styles.paragraph}>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          <li>By email: <a href="mailto:info@amlgolabs.com" className={styles.link}>info@amlgolabs.com</a></li>
        </ul>
      </section>
    </div>
  );
